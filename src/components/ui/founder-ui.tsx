                ...
                >
                  ...
                  >
                    <div className="flex-1 min-w-0 flex flex-col items-center md:items-start text-center md:text-left justify-between py-1 gap-2 sm:gap-3">
                      <h3
                        title={item.stat}
                        className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-foreground leading-tight w-full font-heading"
                      >
                        {item.stat}
                      </h3>
        ...
        {items.map((item, idx) => {
          ...
          return (
            ...
            >
              {isSelected && (
                <div
                  className="h-full rounded-[3px] bg-uisb-purple dark:bg-uisb-orange"
                  style={{
